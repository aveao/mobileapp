...
internal class ImageEncoderTest {
    ...
    @Test
    fun matchesAgainstScreenColours() {
        // Cross-check against an independent implementation of the same median cut over the
        // measured screen colours: a port that silently fell back to nominal matching, or got the
        // normalisation wrong, would choose a different set.
